# HW 3 Marketing Analytics 2026 - Spark API

## Overview

Students shall build a complete **Customer Churn Prediction Pipeline** using Python and Spark API.
...
Students must complete the same functions as HW1 starter code but using Spark API
...
- Load and inspect tabular with Spark API
- Verify different datasets and define accordingly which training models to use with Spark API
- Define train and test dataset
- Handle missing values
- Identify categorical and numerical features
- Build preprocessing pipelines with Spark API
- Train machine learning classification models with Spark API
...
Students MUST use the following libraries based on Python version at least 3.12:

[installation guide PySpark](https://spark.apache.org/docs/latest/api/python/getting_started/install.html)
[Windows Install](https://www.geeksforgeeks.org/installation-guide/install-apache-spark-in-a-standalone-mode-on-windows/)
[Mac install](https://medium.com/@GalarnykMichael/install-spark-on-mac-pyspark-453f395f240b)
...
Implement dataset loading using Spark API.
...
## Step 7 — Train Model
Train the machine learning model usin spark API
